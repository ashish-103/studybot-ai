        ...
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  {heading !== "Exam" ? `Question: ${heading}` : heading}
                </h3>
                <div className="mt-2">
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button
                type="button"
                className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#0AA6D7] text-base font-medium text-white hover:bg-[#0AA6D7] focus:outline-none focus:ring-2 focus:ring-offset-2  sm:ml-3 sm:w-auto sm:text-sm"
                onClick={() => {
                  if (heading !== "Exam") {
                    handleCloseModal();
                  }
